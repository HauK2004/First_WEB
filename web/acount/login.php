                            ...
                            <div class="row">
                                ...
                                <form method="post" action="index.php?page=login">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb20 ">
                                        <button class="btn btn-primary btn-block mb10" name="Login" type="submit">Đăng nhập</button>
                                        <div style="margin: 0 auto; width: 50%">
                                            <a href="index.php?page=register" style="margin-right: 40px;" class="text-blue">Đăng ký</a>
                                            <a href="index.php?page=forgotPass" class="text-blue">Quên mật khẩu </a>
                                        </div>
                                    </div>
                                </form>
